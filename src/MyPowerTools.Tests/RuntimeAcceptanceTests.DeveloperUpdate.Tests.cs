...
public sealed partial class RuntimeAcceptanceTests
{
    ...
    public void Windows_developer_update_overlays_the_complete_installed_runtime()
    {
        ...
        Assert.Contains("'service-units not selected by Scope Tools'", script, StringComparison.Ordinal);
        Assert.Contains("Publish-ToolServiceUnit", script, StringComparison.Ordinal);
        Assert.Contains("Find-ToolServiceUnits", script, StringComparison.Ordinal);
        Assert.Contains("[void](Invoke-Native @publishParameters)", script, StringComparison.Ordinal);
        ...
        Assert.Contains("Stop-ToolPackageRuntimes", script, StringComparison.Ordinal);
        Assert.Contains("Get-ProcessesInDirectory", script, StringComparison.Ordinal);
