...
```text
android-tools.remote-commands.run
android-tools.remote-commands.run-last
android-tools.remote-commands.open-history
android-tools.remote-commands.manage-hosts
```
...
```text
android-tools.process-monitor.open
android-tools.process-monitor.refresh
android-tools.process-monitor.toggle-watch
```
